...
const resources = {
    en: {
        translation: {
            ...
            "You may use these notations for better readability or in theoretical descriptions, but in the grammar input field always write the ASCII versions with spaces, like:": "You may use these notations for better readability or in theoretical descriptions, but in the grammar input field always write the ASCII versions with spaces, like:",
    ...
    sk: {
        translation: {
            ...
            "You may use these notations for better readability or in theoretical descriptions, but in the grammar input field always write the ASCII versions with spaces, like:": "Tieto zápisy môžete používať pre lepšiu čitateľnosť alebo v teoretických popisoch, ale vo vstupnom poli gramatiky vždy používajte ASCII verzie s medzerami, napríklad:",
